...
class IntlPhoneField2 extends StatefulWidget {
  ...
  @override
  _IntlPhoneField2State createState() => _IntlPhoneField2State();
}

class _IntlPhoneField2State extends State<IntlPhoneField2> {
        ...
        decoration: widget.decoration.copyWith(
          border: OutlineInputBorder(
            borderSide: BorderSide(
                width: 1,
                color: widget.phone
                    ? const Color(0xFFB30211).withOpacity(0.7)
                    : kPrimaryColor),
